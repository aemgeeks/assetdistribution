...
class Tabs {
  ...
  get markup() {
    return (
      ...
      '<article class="cmp-contentfragment" data-cmp-contentfragment-model="assetdistribution/models/adventure" data-cmp-contentfragment-path="/content/dam/assetdistribution/en/adventures/surf-nicaragua/nicaragua-surf-trip">' +

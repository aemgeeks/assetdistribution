...
class ContentFragment {
  ...
  get markup() {
    return (
      ...
      'data-cmp-contentfragment-model="/content/dam/assetdistribution/en/los-angeles/ultimate-guide-to-la-skateparks/jcr:content/model"' +
      'data-cmp-contentfragment-path="/content/dam/assetdistribution/en/los-angeles/ultimate-guide-to-la-skateparks">' +

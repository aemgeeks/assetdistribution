...
jQuery(function($) {
    ...
    (function() {
        const form = $('#assetdistribution-sign-in-form');
        if(form) {
    ...
    $('body').on('assetdistribution-modal-show', function() {
        const slingRedirectInput = $('#assetdistribution-sign-in-form input[name="sling.auth.redirect"]');

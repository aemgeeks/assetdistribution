package com.asset.distribution.core.models;
...
/**
 * Represents the assetdistribution Image List Component
 */
public interface ImageList {
    ...
    interface ListItem{
        /**
         * This method returns a resource that is an assetdistribution Image Component resource (rather than an image binary, such as a DAM asset).
         * This resource is intended to be rendered via the assetdistribution Image Component's logic via a Sling include of this resource.
         *

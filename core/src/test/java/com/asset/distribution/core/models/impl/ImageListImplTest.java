...
//  */
// package com.asset.distribution.core.models.impl;

// import com.asset.distribution.core.models.ImageList;
...
//     @BeforeEach
//     void setUp() {
//         ctx.load().json("/com/asset/distribution/core/models/impl/ImageListImplTest.json", "/content");
...
//         assertEquals("assetdistribution/components/image-list", actual.getData().getType());
...
//         assertEquals("assetdistribution/components/image-list/image-list-item", listItemData.getType());
